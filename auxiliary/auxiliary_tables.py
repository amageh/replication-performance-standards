...
# Auxiliary functions for creation of regression tables in the notebook --
...
# Specific tables shown in the notebook ----------------------------------
def create_table1(data):
  """
    Creates Table 1 from notebook.
  """
